    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='' class='snake-link'>***</a> - <a href='***' class='snake-link'>KRLOMPOK 5</a> - <a href='***' class='snake-link'>***</a>";
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "On Windows, atau swipe layar anda pada handphone.";
            }
            welcomeTxt.innerHTML = "Ular melintar lintar<p></p>Gunakan <strong>tanda panah</strong> dikeyboardmu untuk memulai game. " + fullScreenText + "<p></p>";
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "Ular Melintar Lintar <p></p>" + message + "<p></p>";
        ...
        function createTryAgainElement() {
            return createGameEndElement("Hahaha CuPU :(", "sbTryAgain", "snake-try-again-dialog");
        }

        function createWinElement() {
            return createGameEndElement("GG JUGA LU! :D", "sbWin", "snake-win-dialog");
        }
...
var gameAreaWidth = document.getElementById('game-area').offsetWidth;
var gameAreaHeight = document.getElementById('game-area').offsetHeight;

// Set the snake's initial position
var snakeX = gameAreaWidth / 2;
var snakeY = gameAreaHeight / 2;

// Set the snake's movement speed
var snakeSpeed = 10;

// Update the snake's position on each frame
 updateSnakePosition(); {
  // Move the snake
  snakeX += snakeSpeed;
  snakeY += snakeSpeed;
  ...
  if (snakeX < 0 || snakeX > gameAreaWidth || snakeY < 0 || snakeY > gameAreaHeight) {
    ...
    if (snakeX < 0) snakeX = gameAreaWidth - 1;
    if (snakeX > gameAreaWidth) snakeX = 0;
    if (snakeY < 0) snakeY = gameAreaHeight - 1;
    if (snakeY > gameAreaHeight) snakeY = 0;
  }
}
